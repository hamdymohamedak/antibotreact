...
exports.useRouter = exports.useRenderTime = void 0;
exports.useUndo = useUndo;
exports.useViewportVisibility = exports.useUserCountry = void 0;
...
function useUndo(initialValue) {
  var _useState91 = (0, _react.useState)([initialValue]),
    _useState92 = _slicedToArray(_useState91, 2),
    history = _useState92[0],
    setHistory = _useState92[1];
  var _useState93 = (0, _react.useState)(0),
    _useState94 = _slicedToArray(_useState93, 2),
    currentStep = _useState94[0],
    setCurrentStep = _useState94[1];
  var set = function set(newValue) {
    var updatedHistory = history.slice(0, currentStep + 1);
    setHistory([].concat(_toConsumableArray(updatedHistory), [newValue]));
